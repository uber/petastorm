...
from dataset_toolkit.cache import CacheBase
...
class LocalDiskCache(CacheBase):
    def __init__(self, path, size_limit_bytes, expected_row_size_bytes, shards=6, cleanup=False, **settings):
        ...
        LocalDiskCache can be used by a dataset-toolkit Reader class to temporarily keep parts of the dataset on a local
        file system storage.
