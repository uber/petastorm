...
class ConcurrentVentilator(Ventilator):
    ...
    def _ventilate(self):
        ...
        logger.debug('DEBUG: Items to ventilate before shuffle: %s', self._items_to_ventilate)
        ...
        logger.debug('DEBUG: Items to ventilate after shuffle: %s', self._items_to_ventilate)
