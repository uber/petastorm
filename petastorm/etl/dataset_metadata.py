...
def _split_row_groups_from_footers(dataset):
    ...
    print('Recovering rowgroup information for the entire dataset. This can take a long time for datasets with '
...
def infer_or_load_unischema(dataset):
    ...
    try:
        ...
        print('Failed loading Unischema from metadata in %s. Assuming the dataset was not created with '
