...
def test_random_shuffling_buffer_can_add_retrieve_flags():
    ...
    q = BatchedRandomShufflingBuffer(5, 3)
...
def test_random_shuffling_buffer_stream_through():
    ...
    a = _feed_a_sequence_through_the_queue(BatchedRandomShufflingBuffer(10, 3), input_sequence)
    b = _feed_a_sequence_through_the_queue(BatchedRandomShufflingBuffer(10, 3), input_sequence)
...
def test_noop_shuffling_buffer_stream_through():
    ...
    actual = _feed_a_sequence_through_the_queue(BatchedNoopShufflingBuffer(), expected)
    assert expected == actual


def test_longer_random_sequence_of_queue_ops():
    """A long random sequence of added and retrieved values"""
    q = BatchedRandomShufflingBuffer(100, 80)
